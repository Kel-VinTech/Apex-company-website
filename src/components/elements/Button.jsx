...
export default function Button({ children, variant = "primary", onClick, href }) {
  const baseStyles = "rounded-lg font-medium items-center text-center transition";
  const variants = {
    ...
    services: "text-xs text-center md:text-sm lg:text-base font-bold px-6 py-4 bg-orange-600 text-gray-200 hover:bg-blue-700 md:w-50",
  };
