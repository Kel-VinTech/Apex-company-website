                  ...
                  lg:grid-cols-3 gap-4 pt-8 pb-20">
                        ...
                        rounded-sm shadow-sm hover:shadow-md transition">
                              <div className="flex flex-col items-center gap-2">
                                 <h1 className="text-sm md:text-lg font-quote font-bold py-2 italic text-blue-900">OUR VISION</h1>
                        ...
                        rounded-sm shadow-sm hover:shadow-md transition">
                              <div className="flex flex-col items-center gap-2">
                                 ...
                                 <h1 className="text-sm md:text-lg font-quote font-bold py-2 italic text-blue-900">OUR MISSION</h1>
                           ...
                           {/* 3 */}
                             ...
                             <div className="h-45 text-center  p-6 bg-red-50 
                                    ...
                                    <div className="flex flex-col items-center gap-2">
                                       ...
                                       <div>
                                          <h1 className="text-sm md:text-lg font-quote font-bold py-2 italic text-blue-900">CORE VALUES</h1>
